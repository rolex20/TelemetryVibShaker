...
// </auto-generated>
// <summary>
//     Enterprise-grade CPU Quality of Service (QoS) and topology management.
//     Provides robust multi-processor-group support for systems exceeding
//     64 logical processors (e.g., HEDT, Threadripper, Xeon, EPYC).
// </summary>
//------------------------------------------------------------------------------
using System;
...
{
    /// <summary>
    /// Provides advanced thread and process scheduling controls, including CPU Sets,
    /// EcoQoS (Power Throttling), and hard affinity management.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <b>Architecture Overview:</b>
    /// This class is fully processor-group aware. It dynamically queries the system's 
    /// underlying <c>SYSTEM_CPU_SET_INFORMATION</c> to map efficiency classes (e.g., P-Cores 
    /// vs. E-Cores on Intel hybrid architectures) and safely handles environments spanning 
    /// multiple processor groups (systems with > 64 logical processors).
    /// </para>
    /// <para>
    /// <b>Key Capabilities:</b>
    /// <list type="bullet">
    ///     <item>
    ///         <description><b>EcoQoS:</b> Throttles thread execution speed to maximize power efficiency.</description>
    ///     </item>
    ///     <item>
    ///         <description><b>CPU Sets:</b> Applies soft affinity hints respected by the Windows scheduler.</description>
    ///     </item>
    ///     <item>
    ///         <description><b>Hard Affinity:</b> Enforces strict core pinning via <c>SetThreadGroupAffinity</c>.</description>
    ///     </item>
    /// </list>
    /// </para>
    /// <para>
    /// <i>Note: All thread-scoped operations are strictly isolated to the calling thread 
    /// and do not mutate the application's base process affinity mask.</i>
    /// </para>
    /// </remarks>
