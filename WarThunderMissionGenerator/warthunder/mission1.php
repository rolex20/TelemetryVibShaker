...
function storePostDataAsJson($filename) {
	...
	$GLOBALS['status'] = 'Mission generated at ' . date('Y-m-d H:i:s');
...
<title>Mission Generator for War Thunder</title>
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            fetch('warthunder.json?adsf=34df5')
...
<div class="container">
    <form method="POST" align="center" action="mission1.php">
        ...
        <!-- Footer message -->
        <div id="result" class="footer-message"><A HREF="generate_mission.php"><?=$GLOBALS['status']?></A></div>
    </form>
</div>
